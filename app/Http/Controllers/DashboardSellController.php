...
class DashboardSellController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.sell.list',['data' => $data]);
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.sell.add',[
            'currency'  => $currency,
            'bank'      => $bank
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if($validate->fails()){
            ...
            $typetransaction    = TypeTransaction::where('name','sell')->get();
            ...
            if(isset($request->count)){
                ...
                $data->save();
                $message = 'Transaksi Berhasil di tambahkan, silakan cek di daftar Penjualan anda.';
            ...
            $text =
                ...
                . "TUKAR UANG [SELL] \n"
                . getenv('APP_URL')."dashboard/sell/list/".$data->id
            ...
            return redirect()->route('sell')->with('notification',$message);
        }
    }
